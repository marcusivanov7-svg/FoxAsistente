...
PROJECTS_DIR     = Path.home() / "Desktop" / "FoxProjects"
MAX_FIX_ATTEMPTS = 5
MODEL_PLANNER    = get_model_for("agents", "gemini-flash-latest")
MODEL_WRITER     = get_model_for("agents", "gemini-flash-latest")
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "fox_project")
