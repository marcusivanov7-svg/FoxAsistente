"""
file_processor.py — FOX Universal File Processor
        ...
        'properties': {   'file_path': {   'type': 'STRING',
                          ...
                          'action': {   'type': 'STRING',
                                        'description': 'What to do with the file. '
                                                       ...
                                                       'convert | info\n'
                                                       'pdf: summarize | '
                                                       'extract_text | to_word | '
                                                       'info\n'
                                                       'docx/txt: summarize | fix '
                                                       '| reformat | '
                                                       'translate_hint | '
                                                       'word_count | to_bullet\n'
                                                       'csv/excel: analyze | stats '
                                                       '| filter | sort | convert '
                                                       '| info\n'
                                                       ...
                                                       'fix | optimize | run | '
                                                       'document | test\n'
                                                       'audio: transcribe | trim | '
                                                       'convert | info\n'
                                                       'video: trim | '
                                                       'extract_audio | '
                                                       'extract_frame | compress | '
                                                       'transcribe | info | '
                                                       'convert\n'
                                                       'archive: list | extract\n'
                                                       'pptx: summarize | '
                                                       'extract_text | analyze'},
                          'instruction': {   'type': 'STRING',
                                             'description': 'Free-form instruction '
                                                            ...
                                                            "email addresses'"},
                          'format': {   'type': 'STRING',
                                        'description': 'Target format for '
                                                       "conversion. E.g. 'mp3', "
                                                       "'pdf', 'csv', 'png'"},
                          'width': {   'type': 'INTEGER',
                                       'description': 'Target width for image '
                                                      'resize'},
                          'height': {   'type': 'INTEGER',
                                        'description': 'Target height for image '
                                                       'resize'},
                          'scale': {   'type': 'NUMBER',
                                       'description': 'Scale factor for image '
                                                      'resize (e.g. 0.5)'},
                          'quality': {   'type': 'INTEGER',
                                         'description': 'Quality 1-100 for '
                                                        'image/video compress'},
                          'start': {   'type': 'STRING',
                                       'description': 'Start time for trim: '
                                                      'seconds or HH:MM:SS'},
                          'end': {   'type': 'STRING',
                                     'description': 'End time for trim: seconds or '
                                                    'HH:MM:SS'},
                          'timestamp': {   'type': 'STRING',
                                           'description': 'Timestamp for video '
                                                          'frame extraction '
                                                          'HH:MM:SS'},
                          'column': {   'type': 'STRING',
                                        'description': 'Column name for CSV '
                                                       'filter/sort'},
                          'value': {   'type': 'STRING',
                                       'description': 'Filter value for CSV '
                                                      'filter'},
                          'condition': {   'type': 'STRING',
                                           'description': 'Filter condition: '
                                                          'equals|contains|gt|lt'},
                          'ascending': {   'type': 'BOOLEAN',
                                           'description': 'Sort order for CSV sort '
                                                          '(default: true)'},
                          'save': {   'type': 'BOOLEAN',
                                      'description': 'Save result to file '
                                                     '(default: true)'},
                          'destination': {   'type': 'STRING',
                                             'description': 'Output folder for '
                                                            'archive extract'}},
        'required': []},
